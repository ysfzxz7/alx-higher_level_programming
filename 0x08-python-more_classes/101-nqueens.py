#!/usr/bin/python3
"""
This module containg backtrackinh element
"""


def isSafe(m_queen, nqueen):
    """ Meth that determines if the queens can or can't kill each other
    Args:
...
def print_result(m_queen, nqueen):
    """ Meth that prints the list with the Queens positions
    Args:
        m_queen: array that has the queens positions
        nqueen: queen number
    """
